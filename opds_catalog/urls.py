...
urlpatterns = [
    ...
    url(
        r"^catalogs/(?P<cat_id>[0-9]+)/(?P<page>[0-9]+)/$",
        feeds.CatalogsFeed(),
        name="cat_page",
    ),
    ...
    url(
        r"^books/(?P<lang_code>[0-9])/(?P<chars>.+)/$",
        feeds.BooksFeed(),
        name="chars_books",
    ),
    ...
    url(
        r"^authors/(?P<lang_code>[0-9])/(?P<chars>.+)/$",
        feeds.AuthorsFeed(),
        name="chars_authors",
    ),
    ...
    url(
        r"^series/(?P<lang_code>[0-9])/(?P<chars>.+)/$",
        feeds.SeriesFeed(),
        name="chars_series",
    ),
    ...
    url(
        r"^search/books/(?P<searchtype>as)/(?P<searchterms>.+)"
        r"/(?P<searchterms0>.+)/(?P<page>\d+)/$",
        feeds.SearchBooksFeed(),
        name="searchbooks",
    ),
    url(
        r"^search/books/(?P<searchtype>as)/(?P<searchterms>.+)/(?P<searchterms0>.+)/$",
        feeds.SearchBooksFeed(),
        name="searchbooks",
    ),
    url(
        r"^search/books/(?P<searchtype>as)/(?P<searchterms>.+)/$",
        feeds.SelectSeriesFeed(),
        name="searchbooks",
    ),
    url(r"^search/books/u/0/$", feeds.SearchBooksFeed(), name="bookshelf"),
    url(
        r"^search/authors/(?P<searchtype>[bme])/(?P<searchterms>.+)/(?P<page>\d+)/$",
        feeds.SearchAuthorsFeed(),
        name="searchauthors",
    ),
    url(
        r"^search/authors/(?P<searchtype>[bme])/(?P<searchterms>.+)/$",
        feeds.SearchAuthorsFeed(),
        name="searchauthors",
    ),
    url(
        r"^search/series/(?P<searchtype>[bmae])/(?P<searchterms>.+)/(?P<page>\d+)/$",
        feeds.SearchSeriesFeed(),
        name="searchseries",
    ),
    url(
        r"^search/series/(?P<searchtype>[bmae])/(?P<searchterms>.+)/$",
        feeds.SearchSeriesFeed(),
        name="searchseries",
    ),
