    ...
    def parse(self):
        ...
        for inp_file in filelist:
            ...
            for line in finp:
                ...
                # Если решили проверять на наличие ZIP файла или книги в
                # ZIP, а самого ZIP файла нет - то пропускаем вызов callback
                ...
                # Если нужно выполнить проверку книги в ZIP, а ее там не
                # оказалось, то пропускаем вызов callback
                if self.TEST_FILES:
                    if (
