    ...
    [
        ...
        (
            ...
            (
                True,
                _(
                    "Enable telebot authentication. Test presense telegram"
                    " username in local users database (case insensetive)."
                ),
            ),
        ),
        ...
        (
            "SOPDS_TELEBOT_LOG",
            (
                os.path.join(BASE_DIR, "opds_catalog/log/sopds_telebot.log"),
                _("Path to logfile for sopds_telebot process"),
            ),
        ),
        (
            "SOPDS_SERVER_PID",
        ...
        (
            "SOPDS_TELEBOT_PID",
            (
                os.path.join(BASE_DIR, "opds_catalog/tmp/sopds_telebot.pid"),
                _("Path to pidfile for sopds_telebot process"),
            ),
        ),
    ]
)
