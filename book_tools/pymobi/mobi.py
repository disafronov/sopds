...
mobi_exth_type = {
    ...
    113: "asin    Kindle Paperwhite labels books with "
    '"Personal" if they dont have this record.',
    114: "versionnumber",
    115: "sample  0x0001 if the book content is only a sample of the full book",
    116: "startreading    Position (4-byte offset) in file at which to "
    "open when first opened",
    117: "adult   Mobipocket Creator adds this if Adult only is checked on "
    'its GUI; contents: "yes"   <Adult>',
    ...
    201: "coveroffset     Add to first image field in Mobi Header to find "
    "PDB record containing the cover image   <EmbeddedCover>",
    202: "thumboffset     Add to first image field in Mobi Header to find "
    "PDB record containing the thumbnail cover image",
    203: "hasfakecover",
    204: "Creator Software    Known Values: 1=mobigen, 2=Mobipocket "
    "Creator, 200=kindlegen (Windows), 201=kindlegen (Linux), "
    "202=kindlegen (Mac).",
    205: "Creator Major Version",
    206: "Creator Minor Version",
    207: "Creator Build Number",
    208: "watermark",
    209: "tamper proof keys   Used by the Kindle (and Android app) for "
    "generating book-specific PIDs.",
    300: "fontsignature",
    401: "clippinglimit   Integer percentage of the text allowed to be "
    "clipped. Usually 10.",
    402: "publisherlimit",
    403: "Unknown",
...
class BookMobi(object):
    ...
    def datetimeFromValue(self, value):
        ...
        If the time has the top bit clear, it's a signed 32-bit number
        counting from 1st Jan 1970.
        """
